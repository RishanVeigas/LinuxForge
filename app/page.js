    ...
    <div className="bg-[#080c08] text-gray-100 overflow-x-hidden font-display">
        ...
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded border border-[#3ddc84]/40 flex items-center justify-center">
              <span className="text-[#3ddc84] font-mono text-xs font-bold">$_</span>
            </div>
            <span className="font-display font-bold text-white text-sm tracking-tight">LinuxForge</span>
          </div>

          <div className="hidden md:flex items-center gap-8 text-sm text-gray-500 font-mono">
            <a href="#tracks"     className="hover:text-[#3ddc84] transition-colors duration-200">tracks</a>
            <a href="#curriculum" className="hover:text-[#3ddc84] transition-colors duration-200">curriculum</a>
            <a href="#community"  className="hover:text-[#3ddc84] transition-colors duration-200">community</a>
          </div>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center grid-bg pt-14">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="inline-flex items-center gap-2 border border-[#1a2e1a] bg-[#0d120d] rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="font-mono text-xs text-[#3ddc84]">v2.0 — 240 lessons, 12 modules</span>
          </div>
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Learn Linux commands the right way — hands-on, in the terminal, with real feedback. From your first{' '}
            <span className="font-mono text-gray-300 text-base">ls</span> to writing shell scripts that ship to production.
          </p>
          ...
          <div className="max-w-xl mx-auto border border-[#1a2e1a] rounded-lg overflow-hidden bg-[#0d120d] animate-float">
            <div className="border-b border-[#1a2e1a] px-4 py-2.5 flex items-center justify-between">
              ...
              <span className="font-mono text-xs text-gray-600">bash — user@linux:~</span>
              <span />
            </div>
            <div className="p-5 text-left font-mono text-sm space-y-3">
              <div className="text-gray-500 text-xs mb-2"># Interactive terminal. Real commands. Real output.</div>
              <div className="text-[#3ddc84] typewriter">$ ls -la /home/user</div>
              <div className="text-gray-400 text-xs leading-relaxed opacity-0 fade-in-delayed-1">
                <div className="text-gray-600">total 28</div>
                <div><span className="text-[#22d3ee]">drwxr-xr-x</span> documents/ <span className="text-gray-600 ml-2">Apr 20</span></div>
                <div><span className="text-[#22d3ee]">drwxr-xr-x</span> projects/  <span className="text-gray-600 ml-2">Apr 19</span></div>
                <div><span className="text-gray-400">-rw-r--r--</span> .bashrc    <span className="text-gray-600 ml-2">Apr 18</span></div>
              </div>
              <div className="text-[#3ddc84] typewriter-2">$ cd documents</div>
              <div className="text-[#3ddc84] typewriter-3">$ cat report.txt</div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-16 track-enter">
            ...
            <p className="text-gray-500 mt-4 max-w-md mx-auto font-mono text-sm">
              Every developer has been here. Pick your level and we&apos;ll meet you there.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <TrackCard
              ...
              topics={['Bash scripting & loops', 'grep, awk, sed mastery', 'Process management', 'Cron jobs & automation']}
            ...
            <TrackCard
              ...
              topics={['Kernel & system internals', 'Performance & profiling', 'Network stack & sockets', 'Production shell scripting']}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="track-enter">
              ...
              <p className="text-gray-500 font-mono text-sm leading-relaxed mb-8">
                Every lesson runs a real bash environment in your browser. No setup. No VMs. Just you and the shell.
              </p>
              <div className="space-y-5">
                {[
                  { n: '01', title: 'Read the concept',      desc: 'Concise explanations with zero fluff. The important thing is shown — not buried.' },
                  { n: '02', title: 'Run it in the terminal', desc: 'A real shell environment validates your commands. You feel it click.' },
                  { n: '03', title: 'Complete the challenge', desc: 'Each lesson ends with a real-world task. No multiple choice. Just the shell.' },
                ].map((step) => (
                  <div key={step.n} className="flex gap-4">
                    ...
                    <div>
                      <div className="font-display font-semibold text-white text-sm mb-1">{step.title}</div>
            ...
            <div className="track-enter border border-[#1a2e1a] rounded-xl overflow-hidden bg-[#0d120d]">
              <div className="border-b border-[#1a2e1a] px-5 py-3 flex items-center justify-between">
                <span className="font-mono text-xs text-gray-500">module_01 — foundations</span>
                <span className="font-mono text-xs text-[#3ddc84]">12 lessons</span>
              </div>
              <div className="divide-y divide-[#1a2e1a]">
                <LessonRow status="done"   label="01 — Where am I? (pwd)"               />
                <LessonRow status="active" label="02 — Moving around (cd, ls)"           />
                <LessonRow status="locked" label="03 — Creating things (mkdir, touch)"   />
                <LessonRow status="locked" label="04 — Reading files (cat, less)"        />
                <LessonRow status="locked" label="05 — Permissions (chmod, chown)"       />
              </div>
              <div className="px-5 py-3 border-t border-[#1a2e1a]">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="font-mono text-xs text-gray-600">module progress</span>
                  <span className="font-mono text-xs text-[#3ddc84]">1 / 12</span>
                </div>
                <div className="h-1 bg-[#1a2e1a] rounded-full">
                  <div className="h-1 bg-[#3ddc84] rounded-full" style={{ width: '8.33%' }} />
                </div>
              </div>
            </div>
      ...
      <section className="py-20 border-t border-[#1a2e1a] bg-[#0d120d]/30">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12 track-enter">
            <h2 className="font-display text-3xl font-extrabold text-white tracking-tight">What you&apos;ll master</h2>
            <p className="font-mono text-xs text-gray-500 mt-3">A taste of the commands you&apos;ll own by the end</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 track-enter">
            {[
              ...
              <div key={item.cmd} className="path-badge rounded-lg p-4 font-mono text-xs cursor-default hover:border-[#3ddc84]/30 transition-all duration-200">
                <div className="font-bold mb-1" style={{ color: item.color }}>{item.cmd}</div>
      ...
      <section id="community" className="py-24 border-t border-[#1a2e1a]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14 track-enter">
            <h2 className="font-display text-3xl font-extrabold text-white tracking-tight">From the community</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-5 track-enter">
            {[
              {
                initials: 'SK', accentColor: '#22d3ee', accentBg: '#22d3ee10', accentBorder: '#22d3ee20',
                quote: 'I went from googling every command to writing deployment scripts in 4 weeks. The terminal sandbox is what makes it click.',
                name: 'Sadia K.', role: 'Backend Dev · Took Intermediate',
              },
              {
                initials: 'MT', accentColor: '#f59e0b', accentBg: '#f59e0b10', accentBorder: '#f59e0b20',
                quote: 'The expert track is genuinely hard — in the best way. By lesson 20 I was profiling kernel calls. Nothing else teaches this.',
                name: 'Marcus T.', role: 'SRE · Took Expert',
              },
              {
                initials: 'AL', accentColor: '#3ddc84', accentBg: '#3ddc8410', accentBorder: '#3ddc8420',
                quote: 'As a designer learning to code, the beginner track was perfect. No assumptions, no condescension. Just clear, real tasks.',
                name: 'Aiko L.', role: 'Designer → Dev · Took Beginner',
              },
            ].map((t) => (
              <div key={t.initials} className="border border-[#1a2e1a] rounded-xl p-6 bg-[#0d120d]">
                <div className="font-mono text-xs text-[#3ddc84] mb-4">★★★★★</div>
                <p className="text-gray-400 text-sm font-mono leading-relaxed mb-5">&ldquo;{t.quote}&rdquo;</p>
                <div className="flex items-center gap-3">
                  <div
                    className="w-8 h-8 rounded-full flex items-center justify-center font-mono text-xs font-bold"
                    style={{ background: t.accentBg, border: `1px solid ${t.accentBorder}`, color: t.accentColor }}
                  >
                    {t.initials}
                  </div>
                  <div>
                    <div className="font-display text-sm text-white font-semibold">{t.name}</div>
      ...
      <section className="py-24 border-t border-[#1a2e1a] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center track-enter">
          <div className="font-mono text-xs text-gray-600 mb-4 terminal-line">open terminal</div>
          ...
          <p className="text-gray-500 font-mono text-sm mb-10">Free forever on the first module. No card required.</p>
          <button
            onClick={scrollToTracks}
      ...
      <footer className="border-t border-[#1a2e1a] py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-xs text-gray-600">LinuxMastery</span>
          </div>
          <div className="font-mono text-xs text-gray-700">built with ❤ for terminal lovers</div>
...
function TrackCard({ delay, accentColor, number, level, title, description, topics, meta, hoverClass, topLineClass, featured }) {
  return (
    <div
    ...
    >
      {/* Top accent line */}
      <div className={`absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent ${topLineClass} to-transparent rounded-t-xl`} />
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <span
          ...
          style={{ color: accentColor, border: `1px solid ${accentColor}20`, background: `${accentColor}08` }}
        >
          {number}
        </span>
      </div>
      ...
      <div className="mb-1">
        <span className="font-mono text-xs" style={{ color: accentColor }}>{level}</span>
      </div>
      <h3 className="font-display text-2xl font-bold text-white mb-3">{title}</h3>
      <p className="text-gray-500 text-sm leading-relaxed mb-6 font-mono">{description}</p>

      <div className="space-y-2 mb-7">
        {topics.map((t) => (
          <div key={t} className="flex items-center gap-2.5 font-mono text-xs text-gray-500">
            <span className="w-1 h-1 rounded-full" style={{ background: `${accentColor}80` }} />
            {t}
          </div>
        ))}
      </div>
      ...
      <div
        ...
        style={{ borderTop: `1px solid ${featured ? accentColor + '20' : '#1a2e1a'}` }}
      >
        ...
        <button
          ...
          style={{ color: accentColor, fontWeight: featured ? 'bold' : 'normal' }}
        >
          start <span className="group-hover:translate-x-0.5 transition-transform duration-200">→</span>
        </button>
      </div>
    </div>
  );
...
function LessonRow({ status, label }) {
  const configs = {
      ...
      badge: (
        <span className="w-5 h-5 rounded bg-[#3ddc84]/10 border border-[#3ddc84]/20 flex items-center justify-center">
          <svg width="10" height="10" viewBox="0 0 12 10" fill="none">
            <path d="M1 5l3.5 3.5L11 1" stroke="#3ddc84" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </span>
      ),
    ...
    active: {
      ...
      statusEl: <span className="font-mono text-xs text-[#f59e0b]">active</span>,
    ...
    locked: {
      badge: (
        <span className="w-5 h-5 rounded border border-[#1a2e1a] flex items-center justify-center">
          <span className="font-mono text-xs text-gray-600">{label.split('—')[0].trim().replace('0', '')}</span>
        </span>
      ),
  ...
  return (
    <div className={`px-5 py-3.5 flex items-center justify-between hover:bg-white/[0.02] transition-colors cursor-pointer ${c.rowClass}`}>
      <div className="flex items-center gap-3">
        {c.badge}
