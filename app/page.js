...
//       className={`track-enter group relative bg-[#0d120d] border rounded-xl p-7 cursor-pointer transition-all duration-300 ${hoverClass} ${
//         featured ? "border-[#3ddc84]/30 scale-[1.02]" : "border-[#1a2e1a]"
//       }`}
...
//         <button
//           onClick={(e) => {
//             e.stopPropagation(); // prevent parent click double fire
//             handleNavigate();
//           }}
